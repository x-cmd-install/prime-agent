...
[![x-cmd/install — prime-agent Code Quality Monitoring Repo Card](https://repo.x-cmd.io/prime-agent.svg?lang=zh)](https://x-cmd.com/install/prime-agent)
...
合计: **382,494** 行代码（覆盖前 5 种语言、共 **1032** 个文件）。
...
- **最新版本**: `releases/v0.9.1-fhcache1` (2026-09-16)
- **最近提交**: 2026-09-19
- **Release 含资产**: 15 个

## 流行度

- **Star**: 21,109 · **Fork**: 2,310 · **开放 issue**: 370 · **贡献者**: 28

## 累计统计

- **发布数**: 54 · **已合并 PR**: 829 · **开放 PR**: 73 · **已关闭 issue**: 361 · **开放 issue**: 9 · **提交数**: 4796
...
_数据快照: `data/card/260921.yml` · 2026-09-21T04:43:20Z._
